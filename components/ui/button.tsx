...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase tracking-wide",
  {
    variants: {
      variant: {
        default: "bg-white text-blackborder-slate-200 border-2 border-b-4 active:border-b-2 hover:bg-slate-100 text-slate-500",
        ...
        superOutline: "bg-white text-indigox  -500 hover:bg-slate-100",
        ghost:"bg-transparant text-slate-500 border-transparant border-0 hover:bg-slate-100",
        sidebar:"bg-transparant text-slate-500 border-transparant border-0 hover:bg-slate-100 transition-none",
